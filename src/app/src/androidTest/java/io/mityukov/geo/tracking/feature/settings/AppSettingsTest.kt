...
class AppSettingsTest {
    ...
    fun intervalButtonClicked_onIntervalSelectCalled() {
        ...
        composeTestRule.onNodeWithTag(AppTestTag.DROPDOWN_GEOLOCATIONS_UPDATES_INTERVAL).performClick()
        composeTestRule.waitForIdle()
        composeTestRule.onNodeWithTag(AppTestTag.DROPDOWN_ITEM_GEOLOCATIONS_UPDATES_INTERVAL).performClick()

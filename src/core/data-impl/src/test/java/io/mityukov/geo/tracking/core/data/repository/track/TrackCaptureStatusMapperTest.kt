...
import io.mityukov.geo.tracking.core.data.repository.track.capture.TrackCaptureStatusMapper
import io.mityukov.geo.tracking.core.data.repository.track.capture.TrackInProgress
import io.mityukov.geo.tracking.core.data.repository.track.capture.locationFromByteArray
import io.mityukov.geo.tracking.core.data.repository.track.capture.toByteArray
...
class TrackCaptureStatusMapperTest {
    private val trackMapper = TrackCaptureStatusMapper()
